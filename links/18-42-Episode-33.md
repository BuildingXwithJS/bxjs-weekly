...
- [Using the React Context API - getting started](https://dev.to/spences10/using-the-react-context-api---gettingstarted-nje)
...
- [Bit fields in Javascript](https://emergent.systems/blog/bit-fields/)
- [Functional JS with ES6 — Booleans, Conditionals, and Operators](https://medium.com/@caseymorrisus/functional-js-with-es6-church-booleans-conditionals-and-operators-c0461a9e0a66)
...
- [Scalable React Components architecture](https://dev.to/carloscuesta/scalable-react-components-architecture-3k2e)
...
- [Web Assembly for Buzzword Haters](https://dev.to/perigk/web-assembly-for-buzzword-haters-1108)
- [Async function vs. a function that returns a Promise](https://dev.to/mywebstuff_hq/async-function-vs-a-function-that-returns-a-promise-3lpo)
...
- [Using MongoDB as realtime DB with nodeJS](https://medium.com/@sharathvignesh/using-mongodb-as-realtime-db-with-nodejs-c6f52c266750)
- [Introducing GitHub Actions](https://css-tricks.com/introducing-github-actions/)

## Releases:

- [V8 v7.0](https://v8.dev/blog/v8-release-70) and [Chrome 70](https://developers.google.com/web/updates/2018/10/nic70)
...
- [inferno v6.0.0](https://github.com/infernojs/inferno/releases/tag/v6.0.0)
- [Angular 7.0.0](https://blog.angular.io/version-7-of-angular-cli-prompts-virtual-scroll-drag-and-drop-and-more-c594e22e7b8c)
- [LoopBack 4](https://v4.loopback.io/)
- [ganalytics v3.1.0](https://twitter.com/lukeed05/status/1051195348490772481?s=09)
- [VSCode in CodeSandbox](https://twitter.com/CompuIves/status/1052594462768148480?s=09)

## Libs & demos:

- [33-js-concepts](https://github.com/leonardomso/33-js-concepts)
- [bbob](https://github.com/JiLiZART/bbob)
- [budget](https://github.com/victorqribeiro/budget)
- [react-tabulator](https://github.com/ngduc/react-tabulator)
- [just-api](https://github.com/kiranz/just-api)
- [Huffman-Codes](https://github.com/RcrsvSquid/Huffman-Codes)
- [safemd](https://github.com/Hultner/safemd)
- [react-mock](https://github.com/skidding/react-mock)
- [primus-graphql](https://github.com/tjmehta/primus-graphql)
- [evergreen](https://evergreen.segment.com/)
- [crypto-hash](https://github.com/sindresorhus/crypto-hash)
- [checkif.js](https://github.com/joeltankam/checkif.js)
- [megasniff](https://github.com/simsieg/megasniff)
- [schnack](https://github.com/schn4ck/schnack)
- [filter-console](https://github.com/sindresorhus/filter-console)
- [aedes](https://github.com/mcollina/aedes)
- [xmysql](https://github.com/o1lab/xmysql)
- [vlc.js](https://code.videolan.org/jbk/vlc.js)

## Interesting & silly stuff:

- [libssh vulnerabilities](https://www.libssh.org/2018/10/16/libssh-0-8-4-and-0-7-6-security-and-bugfix-release/)
- [HOW FRCKN' HARD IS IT TO UNDERSTAND A URL?! - uXSS CVE-2018-6128](https://www.youtube.com/watch?v=0uejy9aCNbI)
- [Modulz - The next step in visual coding](https://www.kickstarter.com/projects/stephenhaney/modulzthe-next-step-in-visual-coding)
- [spet](http://h313.info/spet/)
