...
- [A simple thing I learned during a code review: Tagged templates](https://dev.to/dvddpl/a-simple-thing-i-learned-during-a-code-review-tagged-templates-1hp5)
...
- [Implementing LRU cache in JavaScript](https://dev.to/udayvunnam/implementing-lru-cache-in-javascript-3c8g)
...
- [Parsing Expressions in JavaScript](https://blog.bitsrc.io/parsing-expressions-in-javascript-4c156f0cbaec)

## Articles & News:

- [Emscripten and the LLVM WebAssembly backend](https://v8.dev/blog/emscripten-llvm-wasm)
- [Supercharge Your Svelte State Management with Akita](https://netbasal.com/supercharge-your-svelte-state-management-with-akita-f1f9de5ef43d)
...
- [React: [Flare] Rethinking Focus](https://github.com/facebook/react/issues/16009)
...
- [Run Python interpreter ported to WebAssembly with Wasmer](https://twitter.com/wasmerio/status/1146477876151115776)
- [Next version of Chrome will enable websites to dynamically put images in the clipboard via the Async Clipboard API](https://twitter.com/WebPlatformNews/status/1146792584108486656)
...
- [VS Code v1.36](https://code.visualstudio.com/updates/v1_36)
- [React Native 0.60](https://facebook.github.io/react-native/blog/2019/07/03/version-60)
- [Overmind v19](https://github.com/cerebral/overmind/releases/tag/release_2019-07-03_1126)
- [npm@6.10.0](https://npm.community/t/release-npm-6-10-0/8584)
- [Babel 7.5.0](https://babeljs.io/blog/2019/07/03/7.5.0)
- [Node v12.6.0](https://nodejs.org/en/blog/release/v12.6.0/)
...
- [use-position](https://github.com/trekhleb/use-position)
...
- [use-custom-element](https://github.com/the-road-to-learn-react/use-custom-element)
...
- [bob](https://github.com/Fishrock123/bob)
