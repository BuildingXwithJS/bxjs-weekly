...
- [Introduction to Readable Javascript: Code Structure](https://carlanderson.xyz/readable-javascript-code-structure/)
- [Maintaining state variables in React](https://logrocket.com/blog/react-url-state/)
- [Using async generators as data streams](https://hackernoon.com/using-async-generators-for-data-streams-f2cd2a1f02b3)
...
- [React/JSX as a server-side templating language](https://blog.kentcdodds.com/react-jsx-as-a-server-side-templating-language-e238555dbc08)
...
- [How I Exposed a Cryptocurrency Exchange's Dirty Tricks to Fight Competition](https://dev.to/leovarmak/how-i-exposed-a-cryptocurrency-exchanges-dirty-tricks-to-fight-competition-31b2)
...
- [PSA: Node.js 11 will be out on October 23rd](https://twitter.com/jasnell/status/1047270913614307328?s=09)
- [Internet Archive is in the process of adding in-browser emulation support for Commodore 64](https://twitter.com/textfiles/status/1048017789884067840)

## Releases:

- [Create React App 2.0](https://reactjs.org/blog/2018/10/01/create-react-app-v2.html)
- [PM2 3.2](https://blog.pm2.io/pm2-runtime-3-2-autumn-features/)

## Libs & demos:

- [node-vulkan](https://github.com/maierfelix/node-vulkan)
- [undux](https://github.com/bcherny/undux)
- [firebase2graphql](https://github.com/hasura/graphql-engine/tree/master/community/tools/firebase2graphql)
- [signal](https://github.com/rxreact/signal)
- [plot-it](https://github.com/samuelnovaes/plot-it)
- [safe-range](https://github.com/samuelnovaes/safe-range)
- [sal](https://github.com/mciastek/sal)
- [johnnydepp](https://github.com/muicss/johnnydepp)
- [loader](https://github.com/jkrems/loader)
- [mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
- [ekill](https://github.com/rhardih/ekill)
- [highground](https://github.com/danielstern/highground)
- [husky](https://github.com/typicode/husky)

## Interesting & silly stuff:

- [GoogleMeetRoulette: Joining random meetings](https://www.martinvigo.com/googlemeetroulette/)
