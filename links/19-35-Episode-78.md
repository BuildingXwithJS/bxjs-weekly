...
- [Translate your React app with ease using Facebook’s own framework (FBT)](https://medium.com/@adamramberg/translate-your-react-app-with-ease-using-facebooks-own-framework-fbt-e8f6af04d3d9)
- [Write fewer, longer tests](https://kentcdodds.com/blog/write-fewer-longer-tests)

## Articles & News:

- [JavaScript: The Modern Parts](https://amontalenti.com/2019/08/10/javascript-the-modern-parts)
- [Bridging Node.js and Python with PyNode to Predict Home Prices](https://thecodinginterface.com/blog/bridging-nodejs-and-python-with-pynode/)
- [Preserving Flash content with WebAssembly done right](https://medium.com/leaningtech/preserving-flash-content-with-webassembly-done-right-eb6838b7e36f)
...
- [npm announces open source funding initiative](https://twitter.com/npmjs/status/1167558875521966080?s=09)

## Tips, tricks & bit-sized awesomeness:

- [Going beyond NPM: meet Yarn & pnpm](https://blog.nicco.io/2019/08/27/going-beyond-npm-meet-yarn-pnpm/)
- [Checklist for choosing an optimal npm package](https://dev.to/adrianbdesigns/checklist-for-choosing-an-optimal-npm-package-4dpm)
- [Making Await More Functional in JavaScript](https://dev.to/craigmichaelmartin/making-await-more-functional-in-javascript-2le4)
...
- [CSS Can Do This... And It's Terrifying!](https://www.aaron-powell.com/posts/2019-08-14-css-can-do-this-and-its-terrifying/?utm_source=CSS-Weekly)
...
- [WebSocketStream is now available in Chrome Canary](https://twitter.com/TypeSong/status/1166957708676714496?s=09)
- [The (brief) history of the `is-buffer` package](https://twitter.com/feross/status/1166531085410263040?s=09)

## Releases:

- [Feathers 4](https://blog.feathersjs.com/introducing-feathers-4-a-framework-for-real-time-apps-and-rest-apis-afff3819055b?gi=e1c9f1a76719)
- [Dojo 6](https://dojo.io/blog/version-6-dojo)
- [TypeScript 3.6](https://devblogs.microsoft.com/typescript/announcing-typescript-3-6/)
- [React Native 0.61.0-rc.0](https://github.com/facebook/react-native/releases/tag/v0.61.0-rc.0)
...
- [react-ast](https://github.com/codejamninja/react-ast)
- [ReactiveSearch](https://github.com/appbaseio/reactivesearch/tree/next/packages/web)
- [creature-chess](https://github.com/Jameskmonger/creature-chess)
- [Trumbowyg](https://github.com/Alex-D/Trumbowyg)
- [csgo-crash-exploit](https://github.com/BeepFelix/csgo-crash-exploit)
