...
- [Promise.race vs. Promise.any And Promise.all vs. Promise.allSettled](https://dev.to/dance2die/promise-race-vs-promise-any-and-promise-all-vs-promise-allsettled-26if)
...
- [How to Create Cool Interactive Sankey Diagrams Using JavaScript](https://hackernoon.com/create-javascript-sankey-diagram-b68c0d508a38)
- [Visual Regression Testing with Puppeteer using Create React App, TypeScript, and Jest](https://levelup.gitconnected.com/create-react-app-jest-enzyme-typescript-jsdom-visual-regression-testing-89f102c29e7)
...
- [How to Build Runnable JavaScript Specifications](https://www.sitepoint.com/runnable-javascript-specifications/)
...
- [Class API proposal for Vue.js is being dropped](https://github.com/vuejs/rfcs/pull/17#issuecomment-494242121)
- [Announcing GitHub Sponsors](https://github.com/sponsors)
- [Preact has moved to a new home on Github](https://twitter.com/_developit/status/1131674868062269441?s=09)
- [pm2 caused thousands of CI builds to fail because of an "optionalDependency"](https://twitter.com/lukejacksonn/status/1131506699356037121?s=09)
...
- [Firefox 67.0](https://www.mozilla.org/en-US/firefox/67.0/releasenotes/)
- [Node v12.3.0](https://nodejs.org/en/blog/release/v12.3.0/)
- [Material-UI v4.0](https://material-ui.com/blog/material-ui-v4-is-out/)
- [express.js v4.17.0](https://github.com/expressjs/express/releases/tag/4.17.0)
- [PixiJS v5](https://medium.com/goodboy-digital/pixijs-v5-lands-5e112d84e510)
...
- [hyperoop](https://github.com/HyperOOP/hyperoop)
- [react-808](https://github.com/joeshub/react-808)
- [tornis](https://github.com/robb0wen/tornis)
- [react-rpm](https://github.com/react-rpm/react-rpm)
- [scar](https://github.com/cloudkj/scar)
- [react-gesture-responder](https://github.com/bmcmahen/react-gesture-responder)
...
- [Oculus Quest is out and it's kinda awesome](https://www.oculus.com/quest/)
